 ...
 * https://vault.hulldamage.org/cc4s.org/doku.php and maybe obtained
 * via the command 
 *
 * git clone username@hulldamage.org:/var/www/git.hulldamage.org/repos/cc4s.git/
 *
 * For information or access to the repository please contact <mailto:F.Hummel@fkf.mpg.de>
 *
