#include <CcdCoulombIntegrals.hpp>
...
ALGORITHM_REGISTRAR_DEFINITION(CcdCoulombIntegrals);

CcdCoulombIntegrals::CcdCoulombIntegrals(
...
/**
 * \brief Calculates Coulomb integrals Vabcd,Vabij,Vaibj,Vijkl from GammaGai,GammaGab,GammaGij Coulomb Vertexes
 */
void CcdCoulombIntegrals::run() {
