...
DryTensor<> *ThermalClusterDoublesAlgorithm::drySliceCoulombIntegrals(int integralsSliceSize) {
...
void ThermalClusterDoublesAlgorithm::sliceIntoResiduum(
...
void ThermalClusterDoublesAlgorithm::printEnergyFromResiduum(CTF::Tensor<> &Rabij)
{
  // Read the Coulomb Integrals Vabij required for the energy
  Tensor<> *Vabij(getTensorArgument<>("PPHHCoulombIntegrals"));
...
DryTensor<> *ThermalClusterDoublesAlgorithm::drySliceAmplitudesFromCoulombFactors(int factorsSliceSize)
{
