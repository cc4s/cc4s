...
#ifndef DCSD_ENERGY_FROM_SLICED_INTEGRALS_DEFINED 
#define DCSD_ENERGY_FROM_SLICED_INTEGRALS_DEFINED
...
namespace cc4s {
   ...
   */
  class DcsdEnergyFromSlicedIntegrals: public ClusterSinglesDoublesAlgorithm {
  public:
    ALGORITHM_REGISTRAR_DECLARATION(DcsdEnergyFromSlicedIntegrals);
    DcsdEnergyFromSlicedIntegrals(
      std::vector<Argument> const &argumentList
    );
    virtual ~DcsdEnergyFromSlicedIntegrals();
