...
LegacyClusterSinglesDoublesAlgorithm::LegacyClusterSinglesDoublesAlgorithm(
...
void LegacyClusterSinglesDoublesAlgorithm::run() {
...
void LegacyClusterSinglesDoublesAlgorithm::dryRun() {
...
double LegacyClusterSinglesDoublesAlgorithm::calculateEnergy() {
...
void LegacyClusterSinglesDoublesAlgorithm::singlesAmplitudesFromResiduum(
  CTF::Tensor<> &Rai
) {
  // Build Dai
...
void LegacyClusterSinglesDoublesAlgorithm::drySinglesAmplitudesFromResiduum(
  cc4s::DryTensor<> &Rai
) {
  // Build Dai
...
Tensor<> *LegacyClusterSinglesDoublesAlgorithm::sliceCoupledCoulombIntegrals(int a, 
                                                                       int b, 
...
DryTensor<> *LegacyClusterSinglesDoublesAlgorithm::drySliceCoupledCoulombIntegrals(int integralsSliceSize)
{
  // Read the Coulomb vertex GammaGqr
...
Tensor<> *LegacyClusterSinglesDoublesAlgorithm::sliceAmplitudesFromCoupledCoulombFactors(int a,
                                                                                   int b,
...
Tensor<> *LegacyClusterSinglesDoublesAlgorithm::amplitudesFromCoupledCoulombFactors()
{
...
DryTensor<> *LegacyClusterSinglesDoublesAlgorithm::drySliceAmplitudesFromCoupledCoulombFactors(int factorsSliceSize)
{
