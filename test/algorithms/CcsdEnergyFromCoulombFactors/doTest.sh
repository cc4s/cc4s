...
# @CLASS=essential,ccsd,trd
TEST_DESCRIPTION="CCSD energy from decomposed Coulomb vertex: check if the energy is within tolerance"
...
COMPARE_ENERGY=$COULOMBFACTORS_CCSD
TOLERANCE=1e-11
