...
# @CLASS=essential,ccd,dcd,trd
TEST_DESCRIPTION="DCD energy from decomposed Coulomb vertex: check if the energy is within tolerance"
...
COMPARE_ENERGY=$COULOMBFACTORS_DCD
TOLERANCE=1e-11
